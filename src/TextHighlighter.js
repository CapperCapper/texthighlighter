(function(global) {
  ...
  var dom = function(el) {
    return /** @lends dom **/ {
      ...
      removeAllRanges: function() {
        var selection = dom(el).getSelection();
        //text will remain highlighted after selection to fix
        //ipad issue where text is still selected visually.
        //but cannot change selection
  ...
  function bindEvents(el, scope) {
    ...
    el.addEventListener("selectionchange", scope.highlightHandler.bind(scope));
  }
  ...
  function unbindEvents(el, scope) {
    ...
    el.removeEventListener(
      "selectionchange",
      scope.highlightHandler.bind(scope)
    );
  }
